...
const UserDetails = ({publicProfile}) => {
  ...
  const getUserDetails = async () => {
    ...
    try {
      ...
      if(publicProfile){
      const response = await axios.get('http://localhost:4000/user?userId='+userId);
  ...
  return (
    ...
    <svg aria-hidden="true" role="status" class="inline w-10 h-10 mr-4 text-gray-200 animate-spin dark:text-gray-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
